...
from tapbench import corpus  # noqa: E402
from tapbench.analyze import bottleneck, keda, stats  # noqa: E402
from tapbench.load import runner as load_runner  # noqa: E402
...
def test_the_stages_are_read_from_the_party_responsible_for_each():
    ...
    watcher = [
        {"t": 995.0, "deployments": {"skao-tap-tap-executor": {"spec_replicas": 1}}},
        {"t": 1015.0, "deployments": {"skao-tap-tap-executor": {"spec_replicas": 3}}},
    ]
    pods = [
        {
            "pod": "exec-new",
