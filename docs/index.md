...
| Concern | Library |
|---|---|
| ADQL parsing & translation to PostgreSQL | [`queryparser-python3`](https://github.com/aipescience/queryparser) (ANTLR-based, translates ADQL geometry to [pg_sphere](https://pgsphere.github.io/)) |
